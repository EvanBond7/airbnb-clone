...
exports.listingResolvers = {
    ...
    Mutation: {
        hostListing: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            //TODO remove 'no image'
            const imageUrl = yield api_1.Cloudinary.upload(input.image || 'no image');
            ...
            //TODO where was ops
            const insertedListing = yield db.users.findOne({
                _id: insertResult.insertedId,
            });
            yield db.users.updateOne({ _id: viewer._id }, { $push: { listings: insertedListing === null || insertedListing === void 0 ? void 0 : insertedListing._id } });
